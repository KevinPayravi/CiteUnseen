...
function processIcon(node, type) {
	...
	switch(type) {
		...
		case "government":
			...
			textNode.setAttribute("alt", "This source has been identified as being state-controlled or state-associated media.");
			textNode.setAttribute("title", "[Cite Unseen] This source has been identified as being state-controlled or state-associated media.");
			break;
		case "news":
